...
async function initializeAuditTable() {
  const createTableQuery = `
    ...
    CREATE INDEX IF NOT EXISTS idx_audit_log_actor ON audit_logs(actor_id);
    CREATE INDEX IF NOT EXISTS idx_audit_log_action ON audit_logs(action);
    CREATE INDEX IF NOT EXISTS idx_audit_log_occurred_at ON audit_logs(occurred_at);
    CREATE INDEX IF NOT EXISTS idx_audit_log_correlation ON audit_logs(correlation_id);
  `;
