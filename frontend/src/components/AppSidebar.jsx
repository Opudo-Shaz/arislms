...
import arislmsLogo from 'src/assets/brand/arislms_logo_fit.png'
  ...
  return (
    ...
    >
      <CSidebarHeader className="border-bottom">
        <CSidebarBrand to="/">
          <img src={arislmsLogo} alt="ARISLMS Logo" className="sidebar-brand-full" style={{ height: '56px', width: 'auto' }} />
